...
(function() {
  var ConsoleLogger, DebugLogger, ErrorLoggerController, Logger, NetLogger, _ref,
  ...
  ErrorLoggerController = (function() {
    ...
    function ErrorLoggerController(config) {
      ...
      this.afterDomReady = __bind(this.afterDomReady, this);
      this.initSending = __bind(this.initSending, this);
